(function() {
  ...
  function initMap() {
    ...
    // NRT operational boundary – Northern Kenya rangelands (simplified)
    var nrtBoundary = [
    ...
    function hidePanel() {
      ...
      panelName.textContent = 'Select a conservancy';
      panelBody.innerHTML = '<p class="conservancy-detail-placeholder">Click any marker on the map to view name, land size, communities, population, carbon credits sold, amount received and spending breakdown.</p>';
    }
